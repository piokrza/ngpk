...
export class CashFlowPaginationService {
  ...
  private setPaginationState(featureName: 'incomes' | 'expenses', paginatorState: PaginatorState): void {
    sessionStorage.setItem(featureName, JSON.stringify(paginatorState));
  }

  private getPaginationState(featureName: 'incomes' | 'expenses'): PaginatorState {
